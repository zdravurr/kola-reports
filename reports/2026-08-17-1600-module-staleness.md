...
• kola-inbox-watcher.service — работает 49.9 ч, старт 2026-08-15 14:06
  запуск: /usr/bin/python3 /home/botuser/.openclaw/workspace/projects/sales/inbox_watcher.py
  НЕ ЗАГРУЖЕНО (7): lib/dirigent_control.py, lib/item_records.py, lib/notify.py, lib/owner_registry.py, lib/owner_updates.py, lib/report_outbox.py, lib/screen_hold.py
