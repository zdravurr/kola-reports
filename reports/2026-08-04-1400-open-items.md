> **DATED SNAPSHOT — 2026-08-04 14:00 UTC.** Byte-identical to the canonical working copy
...
> items as of 2026-08-04 14:00 UTC.** Header re-verified against runtime (`config` import + `git
> rev-parse`), not copied forward. Companion:
> `reports/2026-08-04-1400-titan-sol-card-fix-and-record-corrections.md`.
...
_Last updated: **2026-08-04 14:00 UTC** — HEAD **`44731be`**, header re-verified against runtime, and
