...
• kola-inbox-watcher.service — работает 84.3 ч, старт 2026-08-19 20:01
  запуск: /usr/bin/python3 /home/botuser/.openclaw/workspace/projects/sales/inbox_watcher.py
  НЕ ЗАГРУЖЕНО (28): lib/agent_capacity.py, lib/boss_command.py, lib/claude_cli.py, lib/crm.py, lib/dirigent_control.py, lib/eyes.py, lib/fault_realert.py, lib/item_records.py …
