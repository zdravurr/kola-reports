...
> **DATED SNAPSHOT — 2026-07-27 01:10 UTC.** Identical to the working copy
> `reports/OPEN-ITEMS.md` at Titan session close (HEAD `f0a8d30`).
> This dated path exists because `raw.githubusercontent.com` serves a **cached** copy for a
> reused URL: the working file's link can return a stale version. **This snapshot is the
> authoritative read for 2026-07-27.** The working copy may have moved on since.
