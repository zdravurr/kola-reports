...
• kola-inbox-watcher.service — работает 21.3 ч, старт 2026-08-12 20:22
  запуск: /usr/bin/python3 /home/botuser/.openclaw/workspace/projects/sales/inbox_watcher.py
  НЕ ЗАГРУЖЕНО (7): lib/agent_capacity.py, lib/channel_policy.py, lib/lead_alias.py, lib/name_match.py, lib/reply_proof.py, lib/screen_priority.py, lib/x_tab_guard.py
