> **DATED SNAPSHOT — 2026-08-05 22:50 UTC.** Byte-identical to the canonical working copy
> `reports/OPEN-ITEMS.md` at this commit, published as a new dated path because raw.githubusercontent
> serves a cached copy for any reused URL. **This file is the authoritative reading of Titan's open
> items as of 2026-08-05 22:50 UTC**, at HEAD `22a085e`. Generated FROM the canon, and only after
> `titan-bot/tools/openitems_guard.py` exited 0.
> New this pass: **§2.59 the TTL split recorded (root not closed — closing it means PICKING a
> registry); §2.60 the tolerate-NEUTRAL route measured, negative on every cut, NOT acted on, with a
> pre-registered trigger at 8 further 1H-NEUTRAL admissions on the current geometry.**
