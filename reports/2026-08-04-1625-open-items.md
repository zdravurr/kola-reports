> **DATED SNAPSHOT — 2026-08-04 16:25 UTC.** Byte-identical to the canonical working copy
...
> items as of 2026-08-04 16:25 UTC.** New this pass: **§2.50 — joint geometry, NOTHING applied; the
> unit decided it; §2.49's miss attribution corrected.** No level changed, so all R-multiples remain
> comparable. Companion: `reports/2026-08-04-1625-titan-joint-geometry.md`.
...
_Last updated: **2026-08-04 16:25 UTC** — 🔴 **§2.50 — JOINT GEOMETRY (stop × trail × partial):
