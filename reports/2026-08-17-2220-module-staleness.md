...
• kola-inbox-watcher.service — работает 56.2 ч, старт 2026-08-15 14:06
  запуск: /usr/bin/python3 /home/botuser/.openclaw/workspace/projects/sales/inbox_watcher.py
  НЕ ЗАГРУЖЕНО (10): lib/crm.py, lib/dirigent_control.py, lib/item_records.py, lib/lead_router.py, lib/notify.py, lib/owner_registry.py, lib/owner_updates.py, lib/report_outbox.py …
