> **DATED SNAPSHOT — 2026-08-05 22:13 UTC.** Byte-identical to the canonical working copy
...
> items as of 2026-08-05 22:13 UTC**, at HEAD `2ed2cef`. Generated FROM the canon, and only after
> `titan-bot/tools/openitems_guard.py` exited 0 — header and fenced current-state table machine-checked
> against `import config` and `git rev-parse` before this file was written.
> New this pass: **§0.0 corrected (the 30.07-fork diagnosis was wrong); §2.57 the six 2026-08-05
> commits the canon was missing; §2.58 the real mechanism — stale summaries over a written body;
> §2.58a what is built and what is still only discipline.**
...
🔴 **HEAD `2ed2cef`, re-verified by `git rev-parse` at 2026-08-05 22:13 UTC** — and every value in
