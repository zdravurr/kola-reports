> **DATED SNAPSHOT — 2026-08-04 14:25 UTC.** Byte-identical to the canonical working copy
...
> items as of 2026-08-04 14:25 UTC.** New this pass: **§2.46** (LONG/SHORT asymmetry measured, nothing
> applied) and **§2.45c** (correction to §2.45a's live-era claim). **No code shipped — HEAD is still
> `44731be`.** Companion: `reports/2026-08-04-1425-titan-asymmetric-entry-measured.md`.
...
_Last updated: **2026-08-04 14:25 UTC** — HEAD **`44731be`** (unchanged: the asymmetric-entry pass
shipped **NO CODE**). 🔴 **§2.46 — THE LONG/SHORT ASYMMETRY IS MEASURED AND NOTHING WAS APPLIED**, by
