> **DATED SNAPSHOT — 2026-08-04 16:37 UTC.** Byte-identical to the canonical working copy
...
> items as of 2026-08-04 16:37 UTC.** New this pass: **§2.51 — trail-only 0.75R REJECTED on the arming
> bias; the replay's robust-arming rate reproduces §2.2's measured live rate, so every trail result
> that counted wick-armings is inflated.** SL untouched, 1R fixed, no boundary.
> Companion: `reports/2026-08-04-1637-titan-trail-only-narrowing.md`.
...
_Last updated: **2026-08-04 16:37 UTC** — 🔴 **§2.51 — TRAIL-ONLY 0.75R AT UNCHANGED SL: NOTHING
