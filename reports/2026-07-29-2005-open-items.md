...
> **Both mode flags remain False; the bot is still PAPER and sends nothing.** What changed:
...
> Verified by execution, exit code 3. **Design items 11–14 remain NOT implemented** — see §1; the
> `PARTIAL_FILL_MAX_DIVERGENCE = 0.02` constant is recorded but nothing reads it yet.
