...
• kola-inbox-watcher.service — работает 100.2 ч, старт 2026-08-15 14:06
  запуск: /usr/bin/python3 /home/botuser/.openclaw/workspace/projects/sales/inbox_watcher.py
  НЕ ЗАГРУЖЕНО (14): lib/agent_capacity.py, lib/crm.py, lib/dirigent_control.py, lib/item_records.py, lib/lead_alias.py, lib/lead_router.py, lib/lead_wake_budget.py, lib/notify.py …
