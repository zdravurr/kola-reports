...
> **DATED SNAPSHOT — 2026-07-27 01:00 UTC.** Byte-identical to the working copy
> `reports/OPEN-ITEMS.md` at Titan session close (HEAD `f0a8d30`).
> **This dated path is the authoritative read for 2026-07-27.** It exists because
> `raw.githubusercontent.com` serves a **cached** copy for a reused URL — the working file's
> link has already delivered a stale mid-session version twice. See §8.
